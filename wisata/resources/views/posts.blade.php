...
@section('container')
    ...
    @if ($posts->count())
        <div class="card mb-3">
            ...
            <p>
                <small>
                    Kecamatan {{ $posts[0]->kecamatan->name }}  in <a href="/blog?category={{ $posts[0]->category->slug }}" class="text-decoration-none">{{ $posts[0]->category->name }}</a> | {{ $posts[0]->created_at->diffForHumans() }}
                </small>
            </p>
