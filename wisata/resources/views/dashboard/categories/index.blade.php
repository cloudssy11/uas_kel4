...
@section('container')
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Data Jenis Wisata</h1>
  </div>
  ...
  <div class="table-responsive col-lg-5">
    <a href="/dashboard/categories/create" class="btn btn-primary mb-3">Tambah Jenis Baru</a>
    <table class="table table-striped table-sm">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{ $category->name }}</td>
          <td>
            <a class="badge bg-info" href="/dashboard/categories/{{ $category->slug }}"><span data-feather="eye" class="align-text-bottom"></span></a>
